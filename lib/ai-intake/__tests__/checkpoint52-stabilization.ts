...
function buildRealLikeRows(): RawDocumentPartRow[] {
  ...
  return [
    dim("P1091", 7, 12, 1000, 1000, 0.04, 2, 3.3),
    dim("P1097", 11, 16, 264, 264, 0.07, 2, 8.8),
    dim("P1098", 10, null, 155, 500, 0.08, 2, 6.1),
    dim("P1096", 14, 20, 300, 300, 0.09, 2, 14.1),
    dim("P1093", 15, 20, 280, 580, 0.16, 2, 25.1),
    dim("P1095", 16, 20, 600, 600, 0.36, 2, 56.5),
    dim("P1095", 17, 20, 600, 600, 0.36, 2, 56.5),
    dim("P1092", 18, 20, 600, 600, 0.36, 2, 56.5),
    dim("P1084", 19, 20, 720, 720, 0.52, 2, 81.4),
    dim("P1094", 22, 30, 80, 580, 0.05, 2, 10.9),
  ];
}
