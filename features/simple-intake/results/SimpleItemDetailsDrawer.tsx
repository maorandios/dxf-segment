...
export function SimpleItemDetailsDrawer({
  ...
  onClose,
  onPickDxf,
  onConfirmManual: _onConfirmManual,
  onExclude,
  onRestore,
  onLeaveUnassigned,
  onUseDxfDimensions,
              ...
              if (isAmbiguous) {
                ...
                return (
                  <div className="space-y-3">
                    <p className="text-xs text-muted-foreground">
                      נמצאו כמה קבצים שונים עם אותו מזהה — בחרו את הקובץ הקנוני.
                    </p>
